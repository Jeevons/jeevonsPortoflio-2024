...
export const ContactDialog = ({
  ...
  // 27/07) : `showModal()` ne le bloque pas. Le détail — et le piège du saut
  // latéral quand la barre de défilement disparaît — vit dans le hook, partagé
  // avec le menu mobile du `Header`.
  useScrollLock(open);
